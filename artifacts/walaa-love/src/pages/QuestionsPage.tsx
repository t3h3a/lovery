...
const questions = [
  {
    id: 1,
    text: "إيمان… تتذكري أول مرة سوالفنا؟",
    emoji: "💬",
    choices: [
      { emoji: "😅", text: "أكيد" },
      { emoji: "🤔", text: "يمكن" },
      { emoji: "😂", text: "لا، بس حسّيتها غير" },
    ],
  },
  {
    id: 2,
    text: "وقتها… كنتي تتوقعي توصل بينا السالفة لهالدرجة؟",
    emoji: "🌙",
    choices: [
      { emoji: "😳", text: "لا أبد" },
      { emoji: "😊", text: "يمكن شوي" },
      { emoji: "❤️", text: "إيه، كان عندي إحساس" },
    ],
  },
  {
    id: 3,
    text: "برايج منو فينا طاح أول؟",
    emoji: "💘",
    choices: [
      { emoji: "😏", text: "أنا" },
      { emoji: "😌", text: "إنت" },
      { emoji: "😂", text: "خلنا نقول كلنا" },
    ],
  },
  {
    id: 4,
    text: "شو أكثر شي تحبيه فينا؟",
    emoji: "💕",
    choices: [
      { emoji: "💬", text: "سوالفنا" },
      { emoji: "😂", text: "ضحكتنا" },
      { emoji: "❤️", text: "اهتمامنا ببعض" },
    ],
  },
  {
    id: 5,
    text: "لو حبنا كان مكان… وين تتخيليه؟",
    emoji: "🌌",
    choices: [
      { emoji: "🌊", text: "بحر هادي" },
      { emoji: "🌆", text: "مدينة هادية" },
      { emoji: "🌌", text: "عالم بروحنا" },
    ],
  },
  {
    id: 6,
    text: "بصراحة… أنا شو أمثّل لج؟",
    emoji: "🫶",
    choices: [
      { emoji: "❤️", text: "كل شي" },
      { emoji: "💖", text: "وايد" },
      { emoji: "🫶", text: "شخص مهم وايد" },
    ],
  },
];
